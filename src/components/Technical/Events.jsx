...
const HorizontalScrollCarousel = () => {
  ...
  return (
    <section ref={targetRef} className="relative h-[300vh] px-16 md:px-40">
...
const cards = [
  {
    ...
    title: "Coding Mania",
    description: "Gear up for an intense coding showdown where algorithms meet ingenuity! Participants dive into complex challenges.",
    id: 1,
  },
  {
    url: "https://hitam.org/wp-content/uploads/2022/07/project-expo-Desk.jpg",
    title: "Project Expo",
    description: "Unleash your creativity at the Project Expo! This is your stage to present innovative tech projects, showcase new ideas, and get feedback from peers and experts alike.",
    id: 2,
  },
  {
    url: "https://i.ibb.co/gmJw7ry/Whats-App-Image-2024-10-30-at-14-29-58-7b0c48bb.jpg",
    title: "Capture the Flag",
    description: "Join the hunt in this thrilling cybersecurity challenge! Test your cryptography and hacking skills as you unravel digital puzzles and uncover hidden 'flags' across the web.",
    id: 3,
  },
  {
    url: "https://i.ibb.co/c86scdB/Whats-App-Image-2024-10-30-at-14-36-09-f7c0a18d.jpg",
    title: "Bughunt",
    description: "Become the ultimate bug-slayer in this web-based scavenger hunt! Trace clues, decode puzzles, and test your debugging skills in a series of cryptic URLs.",
    id: 4,
  },
  {
    url: "https://i.ibb.co/2tc95sH/Whats-App-Image-2024-10-30-at-14-35-18-d5b8bed9.jpg",
    title: "Code Quiz",
    description: "Flex your coding knowledge in this dynamic Code Quiz! Answer quick-fire questions, solve code snippets, and climb the leaderboard.",
    id: 5,
  }
];
