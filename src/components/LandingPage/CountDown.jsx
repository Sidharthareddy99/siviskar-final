...
const App = () => {
  ...
  return (
    <div id='count' className='bg-black'>
      <h2 id='count-text' className="text-3xl font-bold md:text-5xl px-6 py-4 md:px-24 text-white opacity-0 translate-y-32">
      Unlock the Fun
                </h2>
                <h1 id='count-text' className="text-4xl  md:text-6xl px-6 font-bold md:px-24 text-transparent opacity-0 translate-y-32"
                                        style={{
